## Thanks for [leiless](https://github.com/leiless)'s [original work](https://github.com/leiless/dnsredir), and this is my personal fork to add more features I want. Of couse more bugs I havn't meet.
